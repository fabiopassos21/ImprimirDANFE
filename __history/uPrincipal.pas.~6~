...
uses
  ...
  ACBrNFeDANFEClass, ACBrNFeDANFEFR, ACBrDFeReport, ACBrDFeDANFeReport;
...
begin
 ...
 // ACBrNFe1.NotasFiscais.LoadFromString('string do xml da nfe', False);     // utilizar quando você grava o XML no BD e tem a string do XML
  // ou
  ACBrNFe1.NotasFiscais.LoadFromFile('C:\Users\Suporte-Fabio\Downloads\projeto\35240249856966000114550060000000931954263922-nfe.xml', FALSE);   // utilizar quando você quer usar o arquivo XML da NFe
